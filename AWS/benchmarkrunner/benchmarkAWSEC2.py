...
def reportToCloudWatch(id: int, log_group:str, log_stream: str,  operation: str, architecture: str, execution_time: float,max_memory_used: float, instance_type: str, file_size_num: int, iteration: int, status: bool):
...
def executeTestCase(executable_command: str, input_data: dict, )-> dict:
    # Start the timer
