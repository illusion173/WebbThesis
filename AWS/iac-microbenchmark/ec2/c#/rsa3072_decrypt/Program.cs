    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine(JsonSerializer.Serialize(new rsa3072_decryptResponse { Message = plaintextMessage }));
            }
            catch (JsonException)
            {
        ...
        private static async Task<string> DecryptMessageAsync(rsa3072_decryptRequest request, string kmsKeyArn)
        {
