...
namespace Program
{
    ...
    public class Program
    {
        ...
        private static async Task<rsa4096_encryptResponse> EncryptMessageAsync(rsa4096_encryptRequest request, string kmsKeyArn)
        {
            ...
            return new rsa4096_encryptResponse
            {
