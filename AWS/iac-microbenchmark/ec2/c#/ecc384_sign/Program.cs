    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                var requestModel = JsonSerializer.Deserialize<ecc384_signRequest>(args[0]);
        ...
        private static async Task<ecc384_signResponse> SignMessageAsync(ecc384_signRequest request, string kmsKeyArn)
        {
            ...
            return new ecc384_signResponse
            {
