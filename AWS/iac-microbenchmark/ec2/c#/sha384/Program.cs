...
namespace Program
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            string? kmsKeyArn = Environment.GetEnvironmentVariable("SHA384_KMS_KEY_ARN");
            if (string.IsNullOrEmpty(kmsKeyArn))
            {
                Console.WriteLine("Error: KMS Key ARN environment variable 'SHA384_KMS_KEY_ARN' is not set.");
                return;
            }
            ...
            try
            {
                ...
                var response = new sha384Response { Signature = signatureBase64 };
