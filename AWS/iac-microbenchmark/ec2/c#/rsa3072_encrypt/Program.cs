...
namespace Program
{
    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                var requestModel = JsonSerializer.Deserialize<rsa3072_encryptRequest>(args[0]);
        ...
        private static async Task<rsa3072_encryptResponse> EncryptMessageAsync(rsa3072_encryptRequest request, string kmsKeyArn)
        {
            ...
            return new rsa3072_encryptResponse
            {
