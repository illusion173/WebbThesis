    ...
    public class Program
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                Console.WriteLine(JsonSerializer.Serialize(new rsa4096_decryptResponse { Message = plaintextMessage }));
            }
            catch (JsonException)
            {
        ...
        private static async Task<string> DecryptMessageAsync(rsa4096_decryptRequest request, string kmsKeyArn)
        {
