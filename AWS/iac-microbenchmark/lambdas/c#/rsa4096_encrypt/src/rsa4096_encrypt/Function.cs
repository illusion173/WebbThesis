    ...
    public class Function
    {
        ...
        public async Task<APIGatewayProxyResponse> FunctionHandler(APIGatewayProxyRequest request, ILambdaContext context)
        {
            ...
            try
            {
                ...
                var requestModel = JsonSerializer.Deserialize<rsa4096_encryptRequest>(request.Body, options);
                ...
                var responseModel = new rsa4096_encryptResponse
                {
            ...
            {
                // Log the exception and return a 500 error response
                context.Logger.LogError($"Error processing request for rsa4096_encrypt c#: {ex.Message}");
                var errorRsp = new Dictionary<string, string>
            {
                { "Error", $"Error processing request for rsa4096_encrypt c#: {ex.Message}" }
            };
