...
async fn function_handler(event: Request) -> Result<Response<Body>, Error> {
    ...
    let message_struct: RSA3072Request = match serde_json::from_str(body_str) {
...
async fn aws_kms_rsa_encrypt(
    ...
    // Return the response
    let rsa_response = RSA3072Response {
