...
public class LambdaHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        try {
            ...
            // Deserialize the request body into Rsa2048EncryptRequestMessage object
            ...
            Rsa2048EncryptResponseMessage responseMessage = new Rsa2048EncryptResponseMessage(
            ...
            Rsa2048EncryptResponseMessage errorResponse = new Rsa2048EncryptResponseMessage(null, null, "Error: " + e.getMessage());
