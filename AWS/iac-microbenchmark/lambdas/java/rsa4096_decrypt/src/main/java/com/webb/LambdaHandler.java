...
public class LambdaHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        try {
            ...
            String Rsa4096DecryptKmsKeyId = System.getenv("RSA4096_KMS_KEY_ARN");
        	
            // Get the JSON string from the request body
            String body = request.getBody();
                    
            // Deserialize the request body into RSA4096 RequestMessage object

            Rsa4096DecryptRequestMessage requestMessage = objectMapper.readValue(body, Rsa4096DecryptRequestMessage.class);
		    ...
		    try {
	            ...
	            Rsa4096DecryptResponseMessage responseMessage = new Rsa4096DecryptResponseMessage(
	            		plaintextMessage
	            );
		        ...
		        // Handle any errors
		        context.getLogger().log("Error Decrypting RSA 4096: " + e.getMessage());
		        
		    	HashMap<String,String> rspErrorBody = new HashMap<>();
		    	rspErrorBody.put("Error", "Error while Decrypting RSA 4096: " + e.getMessage());
