...
public class LambdaHandler implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent request, Context context) {
        ...
        try {
            ...
            // Deserialize the request body into Ecc384SignRequestMessage object
            Ecc384SignRequestMessage requestMessage = objectMapper.readValue(body, Ecc384SignRequestMessage.class);
            ...
            Ecc384SignResponseMessage errorResponse = new Ecc384SignResponseMessage(null, null, "Error: " + e.getMessage());
