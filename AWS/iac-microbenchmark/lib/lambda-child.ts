...
interface BKLambdaChildProps extends cdk.NestedStackProps {
...
export class BKLambdaChildStack extends cdk.NestedStack {
  ...
  constructor(scope: Construct, id: string, props: BKLambdaChildProps) {
    ...
    const { BenchmarkLambdaRole, language, architectures, operations, memorySizes, kmsKeyEnvs } = props;
