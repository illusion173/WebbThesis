...
@app.function_name(name="python_rsa3072_decrypt")
@app.route(route="rsa3072_decrypt")
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if not body:
        return func.HttpResponse(f"ERROR: HTTP request for rsa3072_decrypt is missing body.", status_code=400)
    ...
    try:
        ...
        return func.HttpResponse(f"ERROR: HTTP request for an error for operation rsa3072_decrypt {e} .", status_code=500)
