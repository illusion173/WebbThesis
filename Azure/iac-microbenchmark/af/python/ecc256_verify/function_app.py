...
@app.function_name(name="python_ecc256_verify")
@app.route(route="ecc256_verify")
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    if not body:
        return func.HttpResponse(f"ERROR: HTTP request for ecc256_verify is missing body.", status_code=400)
    ...
    try:
        ...
        # Verify the signature using ECC P-256 (ES256)
        ...
        return func.HttpResponse(f"ERROR: HTTP request for an error for operation ecc256_verify {e} .", status_code=500)
