...
namespace dotnet_rsa3072_encrypt
{
    ...
    public class rsa3072_encrypt_program
    {
        private readonly ILogger<rsa3072_encrypt_program> _logger;

        public rsa3072_encrypt_program(ILogger<rsa3072_encrypt_program> logger)
        {
            _logger = logger;
        }

        [Function("dotnet_rsa3072_encrypt_program")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post")] HttpRequest req)
        {
            ...
            try
            {
                ...
                var requestModel = JsonSerializer.Deserialize<rsa3072_encryptRequest>(requestBodyStr, options);
                ...
                try
                {
                    ...
                    return new OkObjectResult(new rsa3072_encryptResponse
                    {
