...
namespace dotnet_rsa2048_decrypt
{
    ...
    public class rsa2048_decrypt_program
    {
        private readonly ILogger<rsa2048_decrypt_program> _logger;

        public rsa2048_decrypt_program(ILogger<rsa2048_decrypt_program> logger)
        {
            _logger = logger;
        }

        [Function("dotnet_rsa2048_decrypt_program")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post")] HttpRequest req)
        {
            ...
            try
            {
                ...
                var requestModel = JsonSerializer.Deserialize<rsa2048_decryptRequest>(requestBodyStr, options);
                ...
                try
                {
                    ...
                    return new OkObjectResult(new rsa2048_decryptResponse { message = decryptedMessage });
                }
                catch (Exception ex)
                {
