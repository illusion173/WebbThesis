...
namespace dotnet_rsa4096_decrypt
{
    ...
    public class rsa4096_decrypt_program
    {
        private readonly ILogger<rsa4096_decrypt_program> _logger;

        public rsa4096_decrypt_program(ILogger<rsa4096_decrypt_program> logger)
        {
            _logger = logger;
        }

        [Function("dotnet_rsa4096_decrypt_program")]
        public static async Task<IActionResult> Run([HttpTrigger(AuthorizationLevel.Anonymous, "post")] HttpRequest req)
        {
            ...
            try
            {
                ...
                var requestModel = JsonSerializer.Deserialize<rsa4096_decryptRequest>(requestBodyStr, options);
                ...
                try
                {
                    ...
                    return new OkObjectResult(new rsa4096_decryptResponse { message = decryptedMessage });
                }
                catch (Exception ex)
                {
