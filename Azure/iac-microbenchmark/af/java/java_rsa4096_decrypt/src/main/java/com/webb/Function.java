...
public class Function {
    ...
    private static final String RSA4096_KEY_NAME = System.getenv("RSA4096_KEY_NAME");
    private static final ObjectMapper objectMapper = new ObjectMapper();

    
    @FunctionName("java_rsa4096_decrypt")
    public HttpResponseMessage run(
            ...
            final ExecutionContext context) {
                try  {
                    ...
                    rsa4096_decryptRequestMessage rsa4096_decryptrequest = objectMapper.readValue(requestBody, rsa4096_decryptRequestMessage.class);


                    byte[] ivBytes = Base64.getDecoder().decode(rsa4096_decryptrequest.getiv());
                    byte[] cipherTextBytes = Base64.getDecoder().decode(rsa4096_decryptrequest.getciphertext());
                    byte[] encryptedAesKeyBytes = Base64.getDecoder().decode(rsa4096_decryptrequest.getencrypted_aes_key());
                    ...
                    KeyVaultKey key = keyClient.getKey(RSA4096_KEY_NAME);
                    ...
                    rsa4096_decryptResponseMessage responseObj = new rsa4096_decryptResponseMessage(plaintextMessage);
