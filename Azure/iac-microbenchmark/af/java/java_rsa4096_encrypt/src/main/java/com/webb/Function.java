...
public class Function {
    ...
    @FunctionName("java_rsa4096_encrypt")
    public HttpResponseMessage run(
            ...
            final ExecutionContext context) {
                try  {
                    ...
                    rsa4096_encryptRequestMessage rsa4096_encryptrequest = objectMapper.readValue(requestBody, rsa4096_encryptRequestMessage.class);

                    byte[] messageBytes = rsa4096_encryptrequest.getmessage().getBytes();
                    ...
                    rsa4096_encryptResponseMessage responseObj = new rsa4096_encryptResponseMessage(ivBase64, cipherText, encryptedAesKeyBase64);
