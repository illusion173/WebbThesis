...
public class Function {
    ...
    @FunctionName("java_rsa3072_encrypt")
    public HttpResponseMessage run(
            ...
            final ExecutionContext context) {
                try  {
                    ...
                    rsa3072_encryptRequestMessage rsa3072_encryptrequest = objectMapper.readValue(requestBody, rsa3072_encryptRequestMessage.class);

                    byte[] messageBytes = rsa3072_encryptrequest.getmessage().getBytes();
                    ...
                    rsa3072_encryptResponseMessage responseObj = new rsa3072_encryptResponseMessage(ivBase64, cipherText, encryptedAesKeyBase64);
