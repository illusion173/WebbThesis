...
public class Function {
    ...
    @FunctionName("java_rsa2048_decrypt")
    public HttpResponseMessage run(
            ...
            final ExecutionContext context) {
                try  {
                    ...
                    rsa2048_decryptRequestMessage rsa2048_decryptrequest = objectMapper.readValue(requestBody, rsa2048_decryptRequestMessage.class);


                    byte[] ivBytes = Base64.getDecoder().decode(rsa2048_decryptrequest.getiv());
                    byte[] cipherTextBytes = Base64.getDecoder().decode(rsa2048_decryptrequest.getciphertext());
                    byte[] encryptedAesKeyBytes = Base64.getDecoder().decode(rsa2048_decryptrequest.getencrypted_aes_key());
                    ...
                    rsa2048_decryptResponseMessage responseObj = new rsa2048_decryptResponseMessage(plaintextMessage);
