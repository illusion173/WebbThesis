...
public class Function {
    ...
    private static final String ECC256_KEY_NAME = System.getenv("ECC384_KEY_NAME");
    private static final ObjectMapper objectMapper = new ObjectMapper();

    
    @FunctionName("java_ecc256_verify")
    public HttpResponseMessage run(
            ...
            final ExecutionContext context) {
                try  {
                    ...
                    ecc256_verifyRequestMessage ecc256_verifyrequest = objectMapper.readValue(requestBody, ecc256_verifyRequestMessage.class);
                    ...
                    byte[] messageDigestBytes = hexStringToByteArray(ecc256_verifyrequest.getmessage_digest());
                    byte[] signatureBytes = Base64.getDecoder().decode(ecc256_verifyrequest.getsignature());
                    ...
                    ecc256_verifyResponseMessage responseObj = new ecc256_verifyResponseMessage(verifyResult.isValid());
