...
dotenv.config();
export async function rsa3072_encrypt_handler(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
...
app.http('typescript_rsa3072_encrypt', {
    methods: ['POST'],
    authLevel: 'anonymous',
    handler: rsa3072_encrypt_handler
});
