...
dotenv.config();
export async function rsa4096_encrypt_handler(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
...
app.http('typescript_rsa4096_encrypt', {
    methods: ['POST'],
    authLevel: 'anonymous',
    handler: rsa4096_encrypt_handler
});
