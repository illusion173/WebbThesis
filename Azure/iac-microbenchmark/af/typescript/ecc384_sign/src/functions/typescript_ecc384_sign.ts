...
dotenv.config();
export async function ecc384_sign_handler(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
...
app.http('typescript_ecc384_sign', {
    methods: ['POST'],
    authLevel: 'anonymous',
    handler: ecc384_sign_handler
});
