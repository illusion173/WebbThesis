...
dotenv.config();
export async function ecc384_verify_handler(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
...
app.http('typescript_ecc384_verify', {
    methods: ['POST'],
    authLevel: 'anonymous',
    handler: ecc384_verify_handler
});
