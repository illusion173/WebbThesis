...
dotenv.config();
export async function rsa2048_decrypt_handler(request: HttpRequest, context: InvocationContext): Promise<HttpResponseInit> {
...
app.http('typescript_rsa2048_decrypt', {
    methods: ['POST'],
    authLevel: 'anonymous',
    handler: rsa2048_decrypt_handler
});
