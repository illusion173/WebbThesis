...
public class Rsa4096DecryptProgram {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try  {
            ...
            if (args.length != 1) {
                System.err.println("Usage: java Rsa4096Decrypt <message>");
                System.exit(1);
            }
        ...
        Rsa4096DecryptResponseMessage response = new Rsa4096DecryptResponseMessage(plaintextMessage);
