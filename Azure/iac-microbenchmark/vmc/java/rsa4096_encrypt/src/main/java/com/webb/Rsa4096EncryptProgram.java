...
public class Rsa4096EncryptProgram {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try  {
            ...
            if (args.length != 1) {
                System.err.println("Usage: java Rsa4096Encrypt <message>");
                System.exit(1);
            }
        ...
        Rsa4096EncryptResponseMessage response = new Rsa4096EncryptResponseMessage(ivBase64, cipherText, encryptedAesKeyBase64);
